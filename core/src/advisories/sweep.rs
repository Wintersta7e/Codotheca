...
//! record that the question was asked. **No project row, no working copy, no git invocation.** The
//! runner computes each scanned project's advisory items once this returns `Done`.
//!
